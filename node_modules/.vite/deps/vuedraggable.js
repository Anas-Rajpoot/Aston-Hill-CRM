...
var EMPTY_OBJ, EMPTY_ARR, NOOP, NO, isOn, extend, isArray, isString, isSymbol, isObject, isReservedProp, isBuiltInDirective, cacheStringFunction, camelizeRE, camelize, hyphenateRE, hyphenate, capitalize, toHandlerKey, PatchFlagNames, slotFlagsText, GLOBALS_ALLOWED, isGloballyAllowed, range, HTML_TAGS, SVG_TAGS, MATH_TAGS, VOID_TAGS, isHTMLTag, isSVGTag, isMathMLTag, isVoidTag, specialBooleanAttrs, isSpecialBooleanAttr, isBooleanAttr, isKnownHtmlAttr, isKnownSvgAttr, isKnownMathMLAttr;
...
var EMPTY_OBJ2, EMPTY_ARR2, extend2, isReservedProp2, isBuiltInDirective2, cacheStringFunction2, camelizeRE2, camelize2, hyphenateRE2, hyphenate2, capitalize2, toHandlerKey2, GLOBALS_ALLOWED2, isGloballyAllowed2, listDelimiterRE, propertyDelimiterRE, styleCommentRE, HTML_TAGS2, SVG_TAGS2, MATH_TAGS2, VOID_TAGS2, isHTMLTag2, isSVGTag2, isMathMLTag2, isVoidTag2, specialBooleanAttrs2, isSpecialBooleanAttr2, isBooleanAttr2, isKnownHtmlAttr2, isKnownSvgAttr2, isKnownMathMLAttr2;
...
var init_compiler_dom_esm_bundler = __esm({
  "node_modules/@vue/compiler-dom/dist/compiler-dom.esm-bundler.js"() {
    ...
    isKeyboardEvent = makeMap2(`onkeyup,onkeydown,onkeypress`);
...
var EMPTY_OBJ3, EMPTY_ARR3, NOOP2, NO2, isOn2, isModelListener, extend3, remove, hasOwnProperty, hasOwn, isArray2, isMap, isSet, isDate, isRegExp, isFunction, isString2, isSymbol2, isObject2, isPromise, objectToString, toTypeString, toRawType, isPlainObject, isIntegerKey, isReservedProp3, isBuiltInDirective3, cacheStringFunction3, camelizeRE3, camelize3, hyphenateRE3, hyphenate3, capitalize3, toHandlerKey3, hasChanged, invokeArrayFns, def, looseToNumber, toNumber, _globalThis, getGlobalThis, identRE, PatchFlags, PatchFlagNames2, ShapeFlags, SlotFlags, slotFlagsText2, GLOBALS_ALLOWED3, isGloballyAllowed3, isGloballyWhitelisted, range2, listDelimiterRE2, propertyDelimiterRE2, styleCommentRE2, HTML_TAGS3, SVG_TAGS3, MATH_TAGS3, VOID_TAGS3, isHTMLTag3, isSVGTag3, isMathMLTag3, isVoidTag3, specialBooleanAttrs3, isSpecialBooleanAttr3, isBooleanAttr3, unsafeAttrCharRE, attrValidationCache, propsToAttrMap, isKnownHtmlAttr3, isKnownSvgAttr3, isKnownMathMLAttr3, escapeRE, commentStripRE, cssVarNameEscapeSymbolsRE, isRef, toDisplayString, replacer, stringifySymbol;
var init_shared_esm_bundler3 = __esm({
  "node_modules/vue/node_modules/@vue/shared/dist/shared.esm-bundler.js"() {
    ...
    isGloballyWhitelisted = isGloballyAllowed3;
    range2 = 2;
    listDelimiterRE2 = /;(?![^(]*\))/g;
    ...
    toDisplayString = (val) => {
      return isString2(val) ? val : val == null ? "" : isArray2(val) || isObject2(val) && (val.toString === objectToString || !isFunction(val.toString)) ? isRef(val) ? toDisplayString(val.value) : JSON.stringify(val, replacer, 2) : String(val);
    };
    replacer = (_key, val) => {
      if (isRef(val)) {
            ...
            (function(module2, exports2, __webpack_require__) {
              ...
              $({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL }, {
                ...
                keyFor: function keyFor(sym) {
                  if (!isSymbol3(sym)) throw TypeError(sym + " is not a symbol");
              ...
              if ($stringify) {
                ...
                $({ target: "JSON", stat: true, forced: FORCED_JSON_STRINGIFY }, {
                  ...
                  stringify: function stringify(it, replacer2, space) {
                    ...
                    $replacer = replacer2;
                    if (!isObject3(replacer2) && it === void 0 || isSymbol3(it)) return;
                    if (!isArray3(replacer2)) replacer2 = function(key, value) {
                      if (typeof $replacer == "function") value = $replacer.call(this, key, value);
                      if (!isSymbol3(value)) return value;
                    };
                    args[1] = replacer2;
          ...
          "c04e": (
            ...
            (function(module2, exports2, __webpack_require__) {
              ...
              module2.exports = function(input, PREFERRED_STRING) {
                ...
                var fn, val;
                if (PREFERRED_STRING && typeof (fn = input.toString) == "function" && !isObject3(val = fn.call(input))) return val;
                if (typeof (fn = input.valueOf) == "function" && !isObject3(val = fn.call(input))) return val;
                if (!PREFERRED_STRING && typeof (fn = input.toString) == "function" && !isObject3(val = fn.call(input))) return val;
