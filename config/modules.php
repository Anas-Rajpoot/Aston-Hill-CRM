...
return [
    ...
    'clients' => [
        ...
        'columns' => [
            ...
            'fiber' => ['label' => 'Fiber', 'filter' => 'select', 'sortable' => true],
            'order_number' => ['label' => 'ACL', 'filter' => 'text', 'sortable' => true],
            'wo_number' => ['label' => 'WIO', 'filter' => 'text', 'sortable' => true],
            'completion_date' => ['label' => 'Completion Date', 'filter' => 'date', 'sortable' => true],
        ...
        'default_columns' => ['company_name', 'submitted_at', 'manager', 'team_leader', 'sales_agent', 'status', 'service_type', 'product_type', 'address', 'product_name', 'mrc', 'quantity', 'other', 'migration_numbers', 'fiber', 'order_number', 'wo_number', 'completion_date', 'payment_connection', 'contract_type', 'contract_end_date', 'renewal_alert', 'additional_notes'],
        'default_sort' => ['submitted_at', 'desc'],
    ],
