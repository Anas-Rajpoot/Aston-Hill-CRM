...
<div class="bg-white rounded-xl shadow p-6 max-w-xl">
    ...
    <form method="POST" action="<?php echo e(route('super-admin.roles.update', $role)); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\yousa\aston-hill-crm\resources\views\super-admin\roles\edit.blade.php ENDPATH**/ ?>