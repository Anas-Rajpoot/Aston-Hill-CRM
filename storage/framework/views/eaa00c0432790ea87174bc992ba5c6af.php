...
<div class="bg-white rounded-xl shadow p-6 max-w-3xl mx-auto">
    ...
    <form method="POST" action="<?php echo e(route('personal-notes.store')); ?>" class="space-y-4">
        <?php echo csrf_field(); ?>

        <div>
            <label class="block text-sm font-medium text-gray-700">Title</label>
            <input name="title" value="<?php echo e(old('title')); ?>"
        ...
        <div>
            ...
            <textarea name="body" rows="5"
                      class="mt-1 w-full border-gray-300 rounded-md shadow-sm"
                      placeholder="Write details here..."><?php echo e(old('body')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\yousa\aston-hill-crm\resources\views\personal-notes\create.blade.php ENDPATH**/ ?>