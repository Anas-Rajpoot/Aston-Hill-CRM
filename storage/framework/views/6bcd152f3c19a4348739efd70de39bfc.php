...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow p-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('email-followups.index')); ?>" class="text-sm text-gray-600 hover:underline">Back</a>
    </div>

    <form method="POST" action="<?php echo e(route('email-followups.store')); ?>" class="space-y-4">
        <?php echo csrf_field(); ?>

        <div>
            <label class="text-sm font-medium">Email Date</label>
            <input type="date" name="email_date" value="<?php echo e(old('email_date', now()->toDateString())); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
                ...
                <input type="text" name="request_from" value="<?php echo e(old('request_from')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="sent_to" value="<?php echo e(old('sent_to')); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea name="comment" rows="4" class="w-full border-gray-300 rounded-md"
                      placeholder="Optional notes..."><?php echo e(old('comment')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('email-followups.index')); ?>" class="px-4 py-2 rounded-md bg-gray-100">Cancel</a>
        </div>
    </form>

    <p class="text-xs text-gray-500 mt-4">
        Created By will be auto saved as: <span class="font-medium"><?php echo e(auth()->user()->name); ?></span>
    </p>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\yousa\aston-hill-crm\resources\views\email-followups\create.blade.php ENDPATH**/ ?>