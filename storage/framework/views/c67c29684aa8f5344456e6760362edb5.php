...
<div class="bg-white rounded-xl shadow p-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('personal_notes.create')): ?>
            <a href="<?php echo e(route('personal-notes.create')); ?>"
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const table = $('#notesTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('personal-notes.datatable')); ?>",
            data: function (d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\yousa\aston-hill-crm\resources\views\personal-notes\index.blade.php ENDPATH**/ ?>