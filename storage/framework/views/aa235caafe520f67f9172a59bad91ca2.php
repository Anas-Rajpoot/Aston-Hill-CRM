...
<div class="flex items-center justify-between mb-6">
    ...
    <a id="exportBtn"
       ...
       href="<?php echo e(route('login-logs.export.csv')); ?>">
        Export CSV
    </a>
</div>
...
(function () {
    let table = $('#logsTable').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?php echo e(route('login-logs.datatable')); ?>",
            data: function (d) {
    ...
    function updateExportLink() {
        ...
        const base = "<?php echo e(route('login-logs.export.csv')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\yousa\aston-hill-crm\resources\views\login-logs\index.blade.php ENDPATH**/ ?>