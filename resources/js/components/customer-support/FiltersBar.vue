...
<template>
  <div class="rounded-lg border border-gray-200 bg-white px-2 py-2">
    ...
    <select
      ...
      class="w-[220px] shrink-0 rounded border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 focus:border-brand-primary focus:ring-1 focus:ring-brand-primary"
      :disabled="loading"
    >
