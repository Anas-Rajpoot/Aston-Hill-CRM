          ...
          <template v-else>
            <div class="space-y-5 px-6 py-5 overflow-y-auto flex-1 min-h-0">
              ...
              <div v-else-if="isBulk" class="rounded-lg border border-blue-200 bg-blue-50 p-4 flex items-center gap-3">
                ...
                <div>
                  <p class="text-sm font-semibold text-blue-900">{{ bulkIds.length }} submission(s) selected</p>
                  <p class="text-xs text-blue-700 mt-0.5">All selected submissions will be assigned to the same user.</p>
                </div>
              </div>
