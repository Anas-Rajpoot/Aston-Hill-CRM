      ...
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[92vh] flex flex-col overflow-hidden" @click.stop>
        ...
        <div class="px-6 py-4 border-t border-gray-200 flex justify-end gap-3 bg-white">
          ...
          <button
            type="button"
            :disabled="saving"
            class="inline-flex items-center gap-2 rounded-lg bg-teal-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-teal-700 disabled:opacity-50 transition-colors"
            @click="submit"
          >
