...
const activeCount = computed(() => {
  ...
  if (f.mrc_min || f.mrc_max) n++
  if (f.quantity_min || f.quantity_max) n++
  ...
  >
    <div v-show="visible" class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
      ...
      <div class="grid grid-cols-3 gap-x-3 gap-y-2 p-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6">
        ...
        <div>
          <label class="mb-0.5 block text-xs font-medium text-gray-600">MRC Min</label>
          <input
            v-model="filters.mrc_min"
            type="number"
            min="0"
            step="0.01"
            placeholder="Min"
        ...
        <div>
          <label class="mb-0.5 block text-xs font-medium text-gray-600">MRC Max</label>
          <input
            v-model="filters.mrc_max"
            type="number"
            min="0"
            step="0.01"
            placeholder="Max"
        ...
        <div>
          <label class="mb-0.5 block text-xs font-medium text-gray-600">Qty Min</label>
          <input
            v-model="filters.quantity_min"
            type="number"
            min="0"
            placeholder="Min"
            class="w-full rounded border border-gray-300 bg-white px-2 py-1.5 text-xs focus:border-green-500 focus:ring-1 focus:ring-green-500"
        ...
        <div>
          <label class="mb-0.5 block text-xs font-medium text-gray-600">Qty Max</label>
          <input
            v-model="filters.quantity_max"
            type="number"
            min="0"
            placeholder="Max"
            class="w-full rounded border border-gray-300 bg-white px-2 py-1.5 text-xs focus:border-green-500 focus:ring-1 focus:ring-green-500"
