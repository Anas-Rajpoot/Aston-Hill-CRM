    ...
    <div class="w-full">
      <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
        ...
        <div v-else-if="!submission" class="px-4 py-8 text-center text-gray-500 sm:px-5">
          Unable to load request. It may not be in a rejected state or you may not have permission.
        </div>

        <form v-else class="px-4 py-5 sm:px-5" @submit.prevent="resubmit">
          <!-- Validation summary -->
          <div
          ...
          <div class="flex flex-wrap items-center justify-end gap-3 border-t border-gray-200 pt-4">
            ...
            <button type="submit" class="rounded bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700" :disabled="saving">
