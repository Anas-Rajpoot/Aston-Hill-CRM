...
const crumbs = [
  ...
  { label: 'Security, Session & Access Control' },
]
</script>
        ...
        <div class="flex items-start justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 class="text-xl font-bold text-gray-900">Security, Session & Access Control</h1>
              <p class="text-sm text-gray-500 mt-0.5">Manage session security, access restrictions, and system-level permissions</p>
            </div>
          </div>
          <span v-if="!canUpdate && !loading" class="inline-flex items-center rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 border border-blue-200">
            Super Admin Only
          </span>
        </div>
      </div>
