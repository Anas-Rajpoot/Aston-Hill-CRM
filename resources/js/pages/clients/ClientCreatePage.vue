...
function buildPayload() {
  ...
  const payload = {
    ...
    csr_name_2: f.csr_name_2 || null,
    csr_name_3: f.csr_name_3 || null,
  }
  ...
  if (hasCompanyDetail) {
    payload.company_detail = {
      ...
      account_manager_name: cd.account_manager_name || null,
      csr_name_1: cd.csr_name_1 || null,
      csr_name_2: cd.csr_name_2 || null,
      csr_name_3: cd.csr_name_3 || null,
...
async function submit(andAddAnother = false) {
  ...
  try {
    ...
    const data = await clientsApi.store(payload)
    const id = data?.id
    if (andAddAnother) {
      successMessage.value = 'Client created successfully. You can add another below.'
      resetForm()
      setTimeout(() => { successMessage.value = '' }, 4000)
    } else {
      successMessage.value = 'Client created successfully.'
      setTimeout(() => router.push(id ? `/clients/${id}` : '/clients'), 1200)
    }
  } catch (e) {
    const msg = e?.response?.data?.message
    const errs = e?.response?.data?.errors
    error.value = msg || (errs ? Object.values(errs).flat().filter(Boolean).join(' ') : 'Failed to create client.')
  } finally {
    loading.value = false
  }
}
...
<template>
  <div class="min-h-[calc(100vh-4rem)] bg-white py-4 pl-4 pr-0">
    <div class="max-w-full space-y-4">
      ...
      <form @submit.prevent="submit(false)" class="space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <input v-model="form.company_name" type="text" required placeholder="Enter company name" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.company_detail.trade_license_issuing_authority" type="text" placeholder="Select authority" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Company Category <span class="text-red-600">*</span></label>
              <select v-model="form.company_detail.company_category" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500">
            ...
            <div>
              ...
              <input v-model="form.company_detail.trade_license_number" type="text" placeholder="Enter trade license number" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Trade License Expiry Date</label>
              <input v-model="form.company_detail.trade_license_expiry_date" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.company_detail.establishment_card_expiry_date" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.company_detail.account_mapping_date" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.company_detail.account_transfer_given_date" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Account Manager Name <span class="text-red-600">*</span></label>
              <select v-model="form.company_detail.account_manager_name" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500">
                <option value="">Select account manager</option>
                <option v-for="m in teamOptions.managers" :key="m.id" :value="m.name">{{ m.name }}</option>
              </select>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">CSR Name <span class="text-red-600">*</span></label>
              <select v-model="form.company_detail.csr_name_1" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500">
                <option value="">Select CSR</option>
                <option v-for="s in teamOptions.sales_agents" :key="s.id" :value="s.name">{{ s.name }}</option>
              </select>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">CSR Name</label>
              <select v-model="form.company_detail.csr_name_2" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500">
                <option value="">Select CSR</option>
                <option v-for="s in teamOptions.sales_agents" :key="s.id" :value="s.name">{{ s.name }}</option>
              </select>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">CSR Name</label>
              <select v-model="form.company_detail.csr_name_3" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500">
                <option value="">Select CSR</option>
                <option v-for="s in teamOptions.sales_agents" :key="s.id" :value="s.name">{{ s.name }}</option>
              </select>
            </div>
            <div>
              ...
              <input v-model="form.company_detail.first_bill" type="text" placeholder="Enter trade license number" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Second Bill</label>
              <input v-model="form.company_detail.second_bill" type="text" placeholder="Enter trade license number" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Third Bill</label>
              <input v-model="form.company_detail.third_bill" type="text" placeholder="Enter trade license number" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Fourth Bill</label>
              <input v-model="form.company_detail.fourth_bill" type="text" placeholder="Enter trade license number" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
          </div>
          ...
          <div v-for="(contact, idx) in form.contacts" :key="idx" class="mt-4 rounded-lg border border-gray-100 bg-gray-50/50 p-4">
            ...
            <div class="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <div>
                ...
                <input v-model="contact.name" type="text" placeholder="Enter contact person name" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
              </div>
              <div>
              ...
              <div>
                ...
                <input v-model="contact.contact_number" type="text" placeholder="Enter contact number" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
              </div>
              <div>
              ...
              <div>
                ...
                <input v-model="contact.email" type="email" placeholder="Enter email address" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700">Is Updated or Not</label>
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700">Account Transfer Given Date</label>
                <input v-model="contact.as_expiry_date" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
              </div>
        ...
        <!-- Address Information (4 fields, 2 per row; no Emirates) -->
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="border-b border-gray-200 pb-3 text-base font-semibold text-gray-900">Address Information</h2>
          <div class="mt-4 grid grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-700">Complete Address <span class="text-red-600">*</span></label>
              <input v-model="form.addresses[0].full_address" type="text" placeholder="Enter complete address" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Area</label>
              <input v-model="form.addresses[0].area" type="text" placeholder="Enter area" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Building</label>
              <input v-model="form.addresses[0].building" type="text" placeholder="Enter building" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700">Unit</label>
              <input v-model="form.addresses[0].unit" type="text" placeholder="Enter unit number" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
          </div>
        </div>

        <!-- Submission & Product Details (5 columns per row, per 1st image) -->
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="border-b border-gray-200 pb-3 text-base font-semibold text-gray-900">Submission & Product Details</h2>
          <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
            <!-- Row 1: Company Name, Submission Date, Manager Name, Team Leader, Sales Agent Name -->
            <div>
            ...
            <div>
              ...
              <input v-model="form.submitted_at" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.submission_type" type="text" placeholder="New / Resubmit" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.activation_date" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            ...
            <div>
              ...
              <input v-model="form.contract_end_date" type="text" placeholder="dd-mm-yyyy" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
            </div>
            <div>
        ...
        <!-- Account Ownership (icon per ref: light lavender box, three-people in purple; smaller Account Manager field) -->
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div class="flex items-start gap-3">
            ...
            <div>
              <h2 class="text-xl font-bold text-gray-900">Account Ownership</h2>
              <p class="mt-0.5 text-sm text-gray-500">Assign sales hierarchy for this client.</p>
            </div>
          </div>
          <div class="mt-4 flex items-center gap-2 rounded-lg border border-[#C5DBFA] bg-[#E8F0FE] px-4 py-3 text-sm text-[#1A73E8]">
            <svg class="h-5 w-5 shrink-0 text-[#1A73E8]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" />
            </svg>
            <span>Only active employees are available for selection. Changes to account ownership will be logged in the audit trail.</span>
          </div>
          <div class="mt-4 flex flex-wrap items-end justify-between gap-4">
            <div class="w-full max-w-[340px]">
              <label class="block text-sm font-medium text-gray-700">Account Manager Name <span class="text-red-600">*</span></label>
              <select v-model="form.manager_id" class="mt-1 block w-full rounded border border-gray-300 bg-[#F5F5F5] px-3 py-2 text-sm focus:border-green-500 focus:bg-white focus:ring-1 focus:ring-green-500">
                <option :value="null">Select account manager</option>
                <option v-for="m in teamOptions.managers" :key="m.id" :value="m.id">{{ m.name }}</option>
              </select>
            </div>
            <button type="button" class="rounded px-4 py-2 text-sm font-medium text-white transition-colors hover:opacity-90" style="background-color: #21A67B">
              Add Manager
            </button>
          </div>
        </div>

        <!-- Status & Notes (design per 1st ref: green gear icon in light green box, 2-col grid, dd-mm-yyyy) -->
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div class="flex items-start gap-3">
          ...
          <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <select v-model="form.status" class="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500">
            ...
            <div>
              ...
              <div class="relative mt-1">
                <input v-model="form.company_detail.account_mapping_date" type="text" placeholder="dd-mm-yyyy" class="block w-full rounded border border-gray-300 py-2 pl-3 pr-9 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500" />
        ...
        <!-- Buttons (Cancel, Create Client, Create & Add Another) aligned right -->
        <div class="flex flex-wrap items-center justify-end gap-3 border-t border-gray-200 bg-white pt-6">
          <button type="button" class="inline-flex items-center rounded-lg border border-blue-400 bg-white px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-50 disabled:opacity-50" :disabled="loading" @click="cancel">
            Cancel
          </button>
          <button type="submit" class="inline-flex items-center rounded-lg border border-blue-400 bg-white px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-50 disabled:opacity-50" :disabled="loading">
