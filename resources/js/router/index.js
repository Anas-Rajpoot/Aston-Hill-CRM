...
const routes = [
  ...
  { path: '/dashboard', redirect: '/' },
  {
    ...
    children: [
      ...
      { path: 'settings/system-preferences', component: () => import('@/pages/PlaceholderPage.vue'), props: { title: 'System Preferences' }, meta: { title: 'System Preferences' } },
      { path: 'settings/sla', component: () => import('@/pages/PlaceholderPage.vue'), props: { title: 'SLA Configuration' }, meta: { title: 'SLA Configuration' } },
      { path: 'settings/notifications-email', component: () => import('@/pages/PlaceholderPage.vue'), props: { title: 'Notifications & Email Rules' }, meta: { title: 'Notifications & Email Rules' } },
      { path: 'settings/announcement-center', component: () => import('@/pages/PlaceholderPage.vue'), props: { title: 'Announcement Center' }, meta: { title: 'Announcement Center' } },
      { path: 'settings/library', component: () => import('@/pages/PlaceholderPage.vue'), props: { title: 'Library (Templates & Forms)' }, meta: { title: 'Library' } },
      ...
      { path: 'settings/security-session', component: () => import('@/pages/PlaceholderPage.vue'), props: { title: 'Security & Session' }, meta: { title: 'Security & Session' } },
      { path: 'settings/audit-logs', component: () => import('@/pages/PlaceholderPage.vue'), props: { title: 'Audit Logs' }, meta: { title: 'Audit Logs' } },
